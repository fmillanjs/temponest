"""
Authentication middleware for scheduler service.
"""
...
def require_permission(permission: str):
    ...
    Usage: current_user: AuthContext = Depends(require_permission("schedules:create"))
    """
...
def require_any_permission(permissions: List[str]):
    ...
    Usage: current_user: AuthContext = Depends(require_any_permission(["schedules:read", "schedules:execute"]))
    """
    async def permission_checker(
        auth_context: AuthContext = Depends(get_current_user)
    ) -> AuthContext:
